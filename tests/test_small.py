...
class TestSmall(unittest.TestCase):
    ...
    def test_get_or_make_var(self):
        ...
        print("\n\n normalized_numexpr( a + (b - c) ))", normalized_numexpr( a + (b - c)) )
        print("\n\n normalized_numexpr( a + b + c ))", normalized_numexpr( 1*a + 2*b + 3*c) )
        print("\n\n normalized_numexpr( 1*a + 2*( b + c)", normalized_numexpr( 1*a + 2*( b + c) ))

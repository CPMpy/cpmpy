...
class TestSolvers(unittest.TestCase):
    ...
    def test_unit_boolvar(self):
        bv = cp.BoolVar(1)
        self.assertIsInstance(bv, BoolVarImpl, "BoolVar of shape 1 should be base class BoolVarImpl")
        self.assertIsInstance(~bv, NegBoolView)
        self.assertIsInstance(~(~bv), BoolVarImpl)
    ...
    def test_unit_IntVar(self):
        iv = cp.IntVar(0, 1, 1)
        self.assertIsInstance(iv, IntVarImpl, "BoolVar of shape 1 should be base class BoolVarImpl")

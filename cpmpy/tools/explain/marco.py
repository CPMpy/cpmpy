...
def marco(soft, hard=[], solver="ortools", map_solver="ortools", return_mus=True, return_mcs=True, do_solution_hint=True):
    """
        ...
        :param: map_solver: the hitting-set (MAP) solver to use
    ...
    if do_solution_hint and 'solution_hint' not in map_solver.__dict__:
        # subclass does not overwrite solution hinting...

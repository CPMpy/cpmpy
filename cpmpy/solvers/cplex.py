...
class CPM_cplex(SolverInterface):
    ...
    def transform(self, cpm_expr):
        ...
        cpm_cons = linearize_constraint(cpm_cons, supported=frozenset({"->", "sub", "min", "max", "abs"}), csemap=self._csemap)  # CPLEX supports quadratic constraints and division by constants

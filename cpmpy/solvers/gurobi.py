...
class CPM_gurobi(SolverInterface):
    ...
    def transform(self, cpm_expr):
        ...
        supported = {"min", "max", "alldifferent"} # alldiff has a specialized MIP decomp in linearize
        supported_nested = {"min", "max", "alldifferent"} # min and max will be rewritten as non-nested in reify_rewrite
        cpm_cons = decompose_in_tree(cpm_cons, supported, supported_nested) # alldiff has specialized MIP decomp in linearize
